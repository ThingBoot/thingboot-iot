...
| [thingboot-device-esp-idf-sdk](https://github.com/ThingBoot/thingboot-device-esp-idf-sdk) | 芯步设备 ESP-IDF SDK，支持 ESP32 / ESP32-S3 / ESP32-C6 / ESP32-C3，内置 WiFi、以太网、4G Cat.1 与 WiFi Mesh 组网，开箱即用的平台直连与 OTA |
